...
\begin{enumerate}
	...
	\item Да се дефинира функция \texttt{void map ([подходящ тип] array, int n, [подходящ тип]f)}, където \texttt{array} е масив от фикции от тип $double$ с големина \texttt{n}, a f е функция от тип $double \rightarrow double$.\\
