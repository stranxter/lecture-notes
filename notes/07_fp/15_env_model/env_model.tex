...
\begin{frame}[fragile]
\frametitle{Аналог в C++. Subtype полиморфизъм без наследяване?}
...
\begin{frame}[fragile]
\frametitle{Subtype полиморфизъм без наследяване}
...
\begin{frame}[fragile]
\frametitle{Subtype полиморфизъм без наследяване \\ (пример в TypeScript)}
...
console.log(square.area()); \end{lstlisting}
