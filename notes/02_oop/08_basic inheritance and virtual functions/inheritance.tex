...
int main ()
{
  ...
  cout << sumArea<Square> (squares,3) +
          sumArea<Circle> (circles,2);
...
\begin{lstlisting}
template <typename F>
double sumArea(F* figures[], int n)
{
  double sum = 0;
...
\relscale{0.7}
\begin{lstlisting}
double sumArea (Figures* figures[], 
                int n)
{
  double sum = 0;
...
\begin{frame}[fragile]
\frametitle{Ако Figure::area е виртуален}
